...
//  }
  ...
  /**
   * Determines whether this block has the same color and magic
   * state as the given block.
   * @param block
   *   given block
   * @return
   *   true if this block matches the given block
   */
   ...
   * @return
   *   string representation of this block's color
   */
